...
class FrontendAdmin {
    ...
    async loadMenus() {
        try {
            ...
            const response = await csrfFetch('frontend-admin-menus.php', {
                method: 'POST',
                body: formData
            });
    ...
    async loadPages() {
        try {
            ...
            const response = await csrfFetch('frontend-admin-pages.php', {
                method: 'POST',
                body: formData
            });
    ...
    async loadUsers() {
        try {
            ...
            const response = await csrfFetch('frontend-admin-users.php', {
                method: 'POST',
                body: formData
            });
    ...
    async loadAppearance() {
        try {
            ...
            const response = await csrfFetch('frontend-admin-appearance.php', {
                method: 'POST',
                body: formData
            });
    ...
    async loadThemes() {
        try {
            const response = await csrfFetch('frontend-admin-themes.php?action=get_themes');
            const result = await response.json();
    ...
    async selectTheme(themeId) {
        try {
            ...
            const response = await csrfFetch('frontend-admin-themes.php', {
                method: 'POST',
                body: formData
            });
